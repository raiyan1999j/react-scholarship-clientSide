...
export default function ScholarCard({allData}){
    const {university,scholarshipName,country,city,subject,deadline,service,photo} = allData;
    return(
        <>
            <div className="rounded-md shadow-md shadow-gray-400 py-2 px-2 w-[80%] grid grid-cols-[20%_77%] gap-x-4 mb-10">
                <div className="p-4 w-full h-[300px]">
                    <img src={photo} alt="coverPhoto" className="h-full w-full object-cover rounded-xl" />
                </div>
                <div>
                    ...
                    <div className="my-2">
                        <div className="flex flex-row mb-3">
                            ...
                            <p className="ml-4 font-mono text-base font-medium capitalize italic">{country},{city}</p>
                        </div>
                        <div className="flex flex-row mb-3">
                            ...
                            <p className="ml-4 font-mono text-base font-medium capitalize italic">{scholarshipName}</p>
                        </div>
                        <div className="flex flex-row mb-3">
                            ...
                            <p className="ml-4 font-mono text-base font-medium capitalize italic">{subject}</p>
                        </div>
                        <div className="flex flex-row mb-3">
                            ...
                            <p className="ml-4 font-mono text-base font-medium capitalize italic">{deadline}</p>
                        </div>
                        <div className="flex flex-row mb-3">
                            ...
                            <p className="ml-4 font-mono text-base font-medium capitalize italic">{service}</p>
                        </div>
